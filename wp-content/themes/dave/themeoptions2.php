...
class My_Theme_Options {
	...
	public function display_setting( $args = array() ) {
		...
		switch ( $type ) {
			...
			case 'upload':
		 		echo '<input class="upload-url' . $field_class . '" type="text" id="' . $id . '" name="dd_theme_options[' . $id . ']" placeholder="' . $std . '" value="' . esc_attr( $options[$id] ) . '" />';
...
*/				
	...
	*/
	public function styles() {
		...
		wp_register_style( 'mytheme-admin', get_template_directory_uri() . '/css/mytheme-options.css' );
